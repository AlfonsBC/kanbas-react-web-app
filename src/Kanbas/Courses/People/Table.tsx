...
<div id="wd-people-table">
    ...
    className="form-control float-start w-25 me-2 ms-3" />
    <select value={role} onChange={(e) =>filterUsersByRole(e.target.value)} className="form-select float-start w-25 ms-2" >
